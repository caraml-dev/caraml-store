...
import static dev.caraml.store.protobuf.types.ValueProto.ValueType.Enum.STRING_LIST;
...
import dev.caraml.store.protobuf.core.CoreServiceProto;
...
@SpringBootTest
public class RegistryGrpcServiceIT extends BaseIT {
  ...
  public void initState() {
    ...
    EntityProto.EntitySpec entitySpec1 =
        DataGenerator.createEntitySpec(
            "entity1", "Entity 1 description", STRING, Map.of("label_key", "label_value"));
    EntityProto.EntitySpec entitySpec2 =
        DataGenerator.createEntitySpec(
            "entity2", "Entity 2 description", STRING, Map.of("label_key2", "label_value2"));
    ...
    exampleNoMaxAge = DataGenerator.createFeatureTableSpec(
                    "featuretable1",
                    Arrays.asList("entity1", "entity2"),
                    new HashMap<>() {
                      {
    ...
    apiClient.simpleApplyEntity(
        "project1",
        DataGenerator.createEntitySpec(
            "entity3", "Entity 3 description", STRING, Map.of("label_key2", "label_value2")));
  }
  ...
  class ApplyEntity {
    ...
    public void shouldThrowExceptionIfTypeChanged() {
      ...
      EntityProto.EntitySpec spec =
          DataGenerator.createEntitySpec(
              "entity1", "Entity description", FLOAT, Map.of("label_key", "label_value"));
    ...
    public void shouldApplyEntityIfNotExists() {
      ...
      EntityProto.EntitySpec spec =
          DataGenerator.createEntitySpec(
              "new_entity", "Entity description", STRING, Map.of("label_key", "label_value"));
    ...
    public void shouldCreateProjectWhenNotAlreadyExists() {
      EntityProto.EntitySpec spec =
          DataGenerator.createEntitySpec(
              "new_entity2", "Entity description", STRING, Map.of("key1", "val1"));
      CoreServiceProto.ApplyEntityResponse response =
  ...
  public class ApplyFeatureTable {
    ...
    public void shouldApplyNewValidTableWithDefaultMaxAge() {
      ...
      Duration expectedDefaultMaxAge = Duration.newBuilder().setSeconds(2200L).build(); // default max age set in application-it.yaml
      FeatureTableProto.FeatureTableSpec expectedSpec = getTestSpecNoMaxAge().toBuilder()
          .setMaxAge(expectedDefaultMaxAge).build();
    ...
    public void shouldUpdateFeatureTableOnFeatureTypeChange() {
      ...
      FeatureTableProto.FeatureTableSpec updatedSpec =
          getTestSpec().toBuilder()
              .setFeatures(
                  featureIdx,
                  DataGenerator.createFeatureSpec("feature2", STRING_LIST, Collections.emptyMap()))
              .build();
    ...
    public void shouldUpdateFeatureTableOnFeatureAddition() {
      FeatureTableProto.FeatureTableSpec updatedSpec =
          getTestSpec().toBuilder()
              .addFeatures(
                  DataGenerator.createFeatureSpec("feature6", FLOAT, Collections.emptyMap()))
              .build();
    ...
    public void shouldErrorOnMissingBatchSource() {
      FeatureTableProto.FeatureTableSpec spec =
          DataGenerator.createFeatureTableSpec(
                  "ft", List.of("entity1"), Map.of("event_timestamp", INT64), 3600, Map.of())
              .toBuilder()
              .clearBatchSource()
              .build();
    ...
    public void shouldErrorOnInvalidBigQueryTableRef() {
      ...
      FeatureTableProto.FeatureTableSpec spec =
          DataGenerator.createFeatureTableSpec(
                  "ft", List.of("entity1"), Map.of("feature", INT64), 3600, Map.of())
              .toBuilder()
              .setBatchSource(
      ...
      assertThrows(
          ...
          () ->
              apiClient.applyFeatureTable(
                  "default",
                  DataGenerator.createFeatureTableSpec(
                          "f-t", List.of("entity1"), Map.of("feature1", INT64), 3600, Map.of())
                      .toBuilder()
                      .setBatchSource(
                          DataGenerator.createFileDataSourceSpec(
                              "file:///path/to/file", "ts_col", ""))
      ...
      assertThrows(
          ...
          () ->
              apiClient.applyFeatureTable(
                  "default",
                  DataGenerator.createFeatureTableSpec(
                          "ft", List.of("entity1"), Map.of("feature-1", INT64), 3600, Map.of())
                      .toBuilder()
                      .setBatchSource(
                          DataGenerator.createFileDataSourceSpec(
                              "file:///path/to/file", "ts_col", ""))
